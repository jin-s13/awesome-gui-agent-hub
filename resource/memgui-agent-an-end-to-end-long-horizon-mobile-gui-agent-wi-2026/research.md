...
- Status: planned
- Generated at: 2026-07-19T02:05:32Z
...
- topical_relevance: 70.9 - Uses existing LLM keyword relevance scores normalized to 0-100.
- reproducibility: 50 - Screens links and visible text for paper, code, dataset, artifact, and repository signals.
...
- Extract claim-level source spans from the paper.
- Verify linked code, datasets, checkpoints, and benchmark artifacts.
